...
_lr_productions = [
  ...
  ('ifelse -> IFELSE C_LBRACE cond C_RBRACE I_LBRACE stmt_or_empty I_RBRACE ELSE E_LBRACE stmt_or_empty E_RBRACE','ifelse',11,'p_ifelse','parser_for_synthesis.py',245),
  ('while -> WHILE C_LBRACE cond C_RBRACE W_LBRACE stmt_or_empty W_RBRACE','while',7,'p_while','parser_for_synthesis.py',278),
  ('repeat -> REPEAT cste R_LBRACE stmt_or_empty R_RBRACE','repeat',5,'p_repeat','parser_for_synthesis.py',307),
  ('cond -> cond_without_not','cond',1,'p_cond','parser_for_synthesis.py',334),
  ('cond -> NOT C_LBRACE cond_without_not C_RBRACE','cond',4,'p_cond','parser_for_synthesis.py',335),
  ('cond_without_not -> FRONT_IS_CLEAR','cond_without_not',1,'p_cond_without_not','parser_for_synthesis.py',355),
  ('cond_without_not -> LEFT_IS_CLEAR','cond_without_not',1,'p_cond_without_not','parser_for_synthesis.py',356),
  ('cond_without_not -> RIGHT_IS_CLEAR','cond_without_not',1,'p_cond_without_not','parser_for_synthesis.py',357),
  ('cond_without_not -> MARKERS_PRESENT','cond_without_not',1,'p_cond_without_not','parser_for_synthesis.py',358),
  ('cond_without_not -> NO_MARKERS_PRESENT','cond_without_not',1,'p_cond_without_not','parser_for_synthesis.py',359),
  ('action -> MOVE','action',1,'p_action','parser_for_synthesis.py',373),
  ('action -> TURN_RIGHT','action',1,'p_action','parser_for_synthesis.py',374),
  ('action -> TURN_LEFT','action',1,'p_action','parser_for_synthesis.py',375),
  ('action -> PICK_MARKER','action',1,'p_action','parser_for_synthesis.py',376),
  ('action -> PUT_MARKER','action',1,'p_action','parser_for_synthesis.py',377),
  ('cste -> INT','cste',1,'p_cste','parser_for_synthesis.py',392),
  ('empty -> <empty>','empty',0,'p_empty','parser_for_synthesis.py',409),
]
